  ...
  return (
    <div className='row justify-content-center mt-4'>
      <div className='col-md-6 p-4 card shadow'>
        <h3 className='text-primary'>Add clothe</h3>
        ...
        <form onSubmit={handleSubmit}>
          <input type="text"
          placeholder="Enter the clothe name"
          ...
          <input type="text"
          placeholder='Enter the clothe description'
          className='form-control'
          required 
          ...
          <input type="number"
          placeholder='Enter the price of the clothe'
          className='form-control'
          required 
          value={product_cost}
